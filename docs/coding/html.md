...
- 2.3.2.【推荐】不要省略自闭合标签结尾处的斜线，且斜线前需留有一个空格。
  ...
  虽然 [HTML5 规范](https://html.spec.whatwg.org/multipage/) 中指出结尾的斜线是可选的，但保留它们可以明确表达该标签已闭合的语义，更易于维护和理解。
...
<html lang="zh-CN">
  <head>
    <meta charset="utf-8" />
    <meta name="description" content="web前端规范" />
    <meta name="keyword" content="web前端规范" />
    <meta name="viewport" content="width=device-width, minimum-scale=1.0, viewport-fit=cover" />
    <title>web前端规范</title>
    <link rel="stylesheet" href="example.css" />
  </head>
